<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=bahantugas"><i class="fa fa-circle-o"></i>Data Materi dan Tugas</a></li>
        ...
        <!--    <li class="treeview">
            ...
            <li><a href="index.php?view=journalkbm"><i class="fa fa-book"></i><span>Agenda KBM</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=ledgermapel"><i class="fa fa-circle-o"></i> Ledger Mata Pelajaran</a></li>
                <li><a href="index.php?view=ledgerkelas"><i class="fa fa-circle-o"></i> Ledger Kelas</a></li>
                -->
              </ul>
            </li>
