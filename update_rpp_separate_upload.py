#!/usr/bin/env python3
"""
Script to replace checkbox-based RPP upload with separate file upload fields
"""
import re
...
# Find and replace the backend logic section (lines 251-310 approximately)
# This is the section that handles file upload
...
# Now remove the old conditional upload logic (the if/else for file upload)
# This is more complex, so let's do it step by step

# Remove the old if ($filename != '') block and replace with our new logic
# We need to find from line 264 to approximately line 310

# Save the file
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)

print("✅ Backend logic updated successfully!")
