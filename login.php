...
if (isset($_POST['login'])){
 ...
 if ($hitungadmin >= 1){
    ...
    mysql_query("INSERT INTO rb_users_aktivitas VALUES(NULL,'{$r['id_user']}','$ip','$user_browser $version','$user_os','{$r['level']}','".date('H:i:s')."','".date('Y-m-d')."')");
    ...
    $_SESSION['level']    = 'guru';
    include "config/user_agent.php";
    mysql_query("INSERT INTO rb_users_aktivitas VALUES(NULL,'{$r['nip']}','$ip','$user_browser $version','$user_os','guru','".date('H:i:s')."','".date('Y-m-d')."')");
    header("Location: index.php");
    echo "<script>window.location='index.php';</script>";
    exit;
    ...
    include "config/user_agent.php";
    mysql_query("INSERT INTO rb_users_aktivitas VALUES(NULL,'{$r['nisn']}','$ip','$user_browser $version','$user_os','siswa','".date('H:i:s')."','".date('Y-m-d')."')");
    header("Location: index.php");
    echo "<script>window.location='index.php';</script>";
    exit;
 }else{
...
<html>
  <head>
    ...
    <title>NELITA | Learning Management System</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
	  ...
	  <center><img src="foto_pegawai/logosmkn5.jpg"><BR></center>
        <H3>- NELITA -</H3>
        <H3><b>Learning Management System</b><BR> 
        </H3>
      </div><!-- /.login-logo -->
