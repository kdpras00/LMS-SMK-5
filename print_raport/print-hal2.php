...
<body onLoad="window.print()">
    ...
    <table style='font-size:15px' width='100%'>
        ...
        <tr><td>10.</td> <td width='190px'>Sekolah Asal (SMP/MTs)</td>                    <td width='10px'> : </td><td> <?php echo "$s[asal_sekolah]"; ?></td></tr>
        ...
        <tr><td></td> <td width='190px'>Pada Tanggal</td>                                 <td width='10px'> : </td><td> <?php echo "$s[tanggal_terima]"; ?></td></tr>
    ...
    <table width='40%' style='float:right'>
        <tr><td>Tangerang Selatan, <?php echo $s[tanggal_sah]; ?> <br>
