            ...
            <div class="col-xs-12">  
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='#' onclick=\"konfirmasiHapus('index.php?view=penilaianteman&hapus=$r[id_pertanyaan_penilaian]')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
              ...
              setTimeout(function() {
                Swal.fire({
                  ...
                  window.location = 'index.php?view=penilaianteman';
                });
              }, 100);
            </script>";
                      }
...
<?php 
    ...
    if (isset($_POST['tambah'])){
        mysql_query("INSERT INTO rb_pertanyaan_penilaian VALUES(NULL,'$_POST[a]','teman','".date('Y-m-d H:i:s')."')") or die(mysql_error());
        echo "<script>
            setTimeout(function() {
              Swal.fire({
                icon: 'success',
