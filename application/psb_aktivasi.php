                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_POST['tambahkan'])){
                          ...
                          mysql_query("INSERT INTO rb_psb_aktivasi VALUES('','$kode','$_POST[nama]','$_POST[status]','0','".date('Y-m-d H:i:s')."')");
                          echo "<script>document.location='index.php?view=psbaktivasi';</script>";
                      }
...
<?php 
    ...
    if (isset($_POST['update'])){
      ...
      if ($cek['status']==$_POST['b']){
        ...
        mysql_query("UPDATE rb_psb_aktivasi SET kode_pendaftaran = '$kodea',
