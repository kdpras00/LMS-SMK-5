            ...
            <div class="col-xs-12">  
                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='?view=kelas&act=edit&id=".(isset($r['kode_kelas']) ? $r['kode_kelas'] : '')."'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='javascript:void(0)' onclick=\"konfirmasiHapus('index.php?view=kelas&hapus=".(isset($r['kode_kelas']) ? $r['kode_kelas'] : '')."')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
              ...
              setTimeout(function() {
                Swal.fire({
                  ...
                  window.location = 'index.php?view=kelas';
                });
              }, 100);
            </script>";
                      }
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysql_query("UPDATE rb_kelas SET kode_kelas = '$_POST[a]',
                                         ...
                                         aktif = '$_POST[f]' where kode_kelas='$_POST[id]'") or die(mysql_error());
      echo "<script>
            setTimeout(function() {
              Swal.fire({
                icon: 'success',
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Kode Kelas</th> <td><input type='text' class='form-control' name='a' value='".(isset($s['kode_kelas']) ? $s['kode_kelas'] : '')."'> </td></tr>
                     ...
                     <tr><th scope='row'>Jurusan</th>               <td><select class='form-control' name='c'> 
                                                                          <option value='0' selected>- Pilih Jurusan -</option>"; 
                                                                            ...
                                                                            while($a = mysql_fetch_array($jur)){
                                                                              if (isset($s['kode_jurusan']) && $a['kode_jurusan'] == $s['kode_jurusan']){
                    ...
                    <tr><th scope='row'>Ruangan</th>               <td><select class='form-control' name='d'> 
                                                                          <option value='0' selected>- Pilih Ruangan -</option>"; 
                                                                            ...
                                                                            while($a = mysql_fetch_array($rua)){
                                                                              if (isset($s['kode_ruangan']) && $a['kode_ruangan'] == $s['kode_ruangan']){
    ...
    if (isset($_POST['tambah'])){
        mysql_query("INSERT INTO rb_kelas VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[g]','$_POST[f]')") or die(mysql_error());
        echo "<script>
            setTimeout(function() {
              Swal.fire({
                icon: 'success',
                ...
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Wali Kelas</th>               <td><select class='form-control' name='b'> 
                                                                         ...
                                                                         echo "</select></td></tr>
                    <tr><th width='120px' scope='row'>Nama Kelas</th> <td><input type='text' class='form-control' name='g'> </td></tr>                                                    
                    <tr><th scope='row'>Jurusan</th>               <td><select class='form-control' name='c'> 
                                                                          <option value='0' selected>- Pilih Jurusan -</option>"; 
                                                                            $jur = mysql_query("SELECT * FROM rb_jurusan");
                                                                            while($a = mysql_fetch_array($jur)){
