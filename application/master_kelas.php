                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='#' onclick=\"konfirmasiHapus('index.php?view=kelas&hapus=$r[kode_kelas]')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
...
<?php 
                ...
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Wali Kelas</th>               <td><select class='form-control' name='b'> 
                                                                         ...
                                                                         echo "</select></td></tr>
					 <tr><th width='120px' scope='row'>Fase</th> <td><input type='text' class='form-control' name='g' value='$s[fase]'> </td></tr>													
                    <tr><th scope='row'>Juruaaaaaaasan</th>               <td><select class='form-control' name='c'> 
    ...
    if (isset($_POST['tambah'])){
        mysql_query("INSERT INTO rb_kelas VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[g]','$_POST[e]','$_POST[f]')") or die(mysql_error());
        echo "<script>
            setTimeout(function() {
              Swal.fire({
                icon: 'success',
                ...
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Ruangan</th>               <td><select class='form-control' name='d'> 
                                                                         ...
                                                                         echo "</select></td></tr>
                    <tr><th scope='row'>Fase</th>           <td><input type='text' class='form-control' name='e' value='$s[nama_kelas]'></td></tr>
