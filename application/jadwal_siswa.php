              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    <input type='hidden' name='view' value='jadwalsiswa'>
                  ...
                  <?php
                    ...
                    if (isset($tampil) && $tampil) {
                        ...
                        echo "<tr><td>$no</td>
                                  ...
                                  <td><a class='btn btn-success btn-xs' title='Lihat Data' href='index.php?view=jadwalsiswa&act=kompetensidasar&kodejdwl=$r[kodejdwl]'><span class='glyphicon glyphicon-list'></span> Kompetensi</a></td>
                              </tr>";
                          $no++;
                          }
                    }
...
<?php 
}elseif (isset($_GET['act']) && $_GET['act']=='kompetensidasar'){
