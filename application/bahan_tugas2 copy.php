              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    <input type="hidden" name='view' value='bahantugas2'>
                  ...
                  <table id="example" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Kelasssssssssssssssssssssssssss</th>
                        <th>Guru</th>
                        <th>Hari</th>
                        <th>Mulai</th>
                        <th>Selesai</th>
                        <th>Ruangan</th>
                        <th>Toooooootallllllllllllll</th>
                        <th>Action</th>
                      </tr>
                    </thead>
                    <tbody>
                  <?php
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              echo "<td style='width:70px !important'><center>
                                      <a class='btn btn-success btn-xs' title='Lihat RPPaa' href='index.php?view=bahantugas2&act=listbahantugas2&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]'><span class='glyphicon glyphicon-th'></span> Lihaaaaat RPP</a>
                                    </center></td>";
                            echo "</tr>";
                      $no++;
                      }
...
<?php 
}elseif($_GET['act']=='listbahantugas2'){
cek_session_siswa();
              ...
              <div class='box box-info'>
                <div class='box-header with-border'>
                  ...
                  if ($_SESSION['level']=='guru'){
                    echo "<a style='margin-left:4px' class='btn btn-danger btn-sm pull-right' href='index.php?view=bahantugas2&act=listbahantugas2guru'>Kembali</a>";
                  }elseif($_SESSION['level']=='siswa'){
                    echo "<a style='margin-left:4px' class='btn btn-danger btn-sm pull-right' href='index.php?view=bahantugas2&act=listbahantugas2siswa'>Kembali</a>";
                  }else{
                    echo "<a style='margin-left:4px' class='btn btn-danger btn-sm pull-right' href='index.php?view=bahantugas2'>Kembali</a>";
                  }

                  if ($_SESSION['level']=='guru' OR $_SESSION['level']=='superuser'){
                    echo "<a class='pull-right btn btn-primary btn-sm' href='index.php?view=bahantugas2&act=tambah&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]'>Tambahkan Data</a>";
                  }
                echo "</div>
              <div class='box-body'>
                  ...
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    while($r=mysql_fetch_array($tampil)){
                          ...
                          if ($_SESSION['level']=='superuser'){
                              echo "<td>";
                                if ($r['id_kategori_elearning']=='1'){
                                  ...
                                  echo "<a style='margin-right:5px; width:106px' class='btn btn-success btn-xs' title='Jawaban Bahan dan Tugas' href='index.php?view=bahantugas2&act=kirimjawaban&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&ide=$r[id_elearning]'><span class='glyphicon glyphicon-upload'></span> Jawaban </a>";
                                }
                                  echo "<a class='btn btn-success btn-xs' title='Edit Bahan dan Tugas' href='index.php?view=bahantugas2&act=edit&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&edit=$r[id_elearning]'><span class='glyphicon glyphicon-edit'></span></a>
                                        <a class='btn btn-danger btn-xs' title='Delete Bahan dan Tugas' href='index.php?view=bahantugas2&act=listbahantugas2&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&hapus=$r[id_elearning]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-trash'></span></a>
                              </td>
                            </tr>";
                          }elseif ($_SESSION['level']=='siswa'){
                              ...
                              if ($r['id_kategori_elearning']=='1'){
                                  ...
                                  echo "<td><a class='btn btn-info btn-xs' title='Download Bahan dan Tugas' href='download.php?file=$r[file_upload]'><span class='glyphicon glyphicon-download'></span> Download</a>
                                            <a class='btn btn-success btn-xs' title='Kirim Bahan dan Tugas' href='index.php?view=bahantugas2&act=kirim&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&ide=$r[id_elearning]'><span class='glyphicon glyphicon-upload'></span> Kirim Tugas</a></td></tr>";
                              }else{
                              ...
                              if ($r['id_kategori_elearning']=='1'){
                                  ...
                                  echo "<td><a class='btn btn-info btn-xs' title='Download Bahan dan Tugas' href='download.php?file=$r[file_upload]'><span class='glyphicon glyphicon-download'></span> Download</a>
                                            <a class='btn btn-success btn-xs' title='Kirim Bahan dan Tugas' href='index.php?view=bahantugas2&act=jawaban&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&ide=$r[id_elearning]'><span class='glyphicon glyphicon-upload'></span> Jawaban Tugas</a>";
                              }
                                  echo "<a style='margin-left:3px' class='btn btn-warning btn-xs' title='Edit $r[nama_kategori_elearning]' href='index.php?view=bahantugas2&act=edit&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."&edit=$r[id_elearning]'><span class='glyphicon glyphicon-edit'></span></a>
                                        <a class='btn btn-danger btn-xs' title='Delete $r[nama_kategori_elearning]' href='index.php?view=bahantugas2&act=listbahantugas2&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."&hapus=$r[id_elearning]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a></td></tr>";
                          }
                        $no++;
                      }
                      ...
                      if (isset($_GET['hapus'])){
                        ...
                        echo "<script>document.location='index.php?view=bahantugas2&act=listbahantugas2&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."';</script>";
                      }
...
if (isset($_POST['tambah'])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
          ...
          echo "<script>window.alert('Gagal Tambahkan Data Bahan dan Tugas.');
                      window.location='index.php?view=bahantugas2&act=listbahantugas2&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."'</script>";
        }
      }else{
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=bahantugas2'><button class='btn btn-default pull-right'>Cancel</button></a>
                ...
                <div class="box-body">
                  ...
                  <?php
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td style='color:red'>$total Record</td>
                              <td><a class='btn btn-success btn-xs' title='List Bahan dan Tugas' href='index.php?view=bahantugas2&act=listbahantugas2&jdwl=$r[kodejdwl]&id=$r[kode_kelas]&kd=$r[kode_pelajaran]'><span class='glyphicon glyphicon-th'></span> Tampilkan</a></td>
                          </tr>";
                      $no++;
                      }
                  ?>
...
<?php
}elseif($_GET['act']=='listbahantugas2siswa'){ 
cek_session_siswa();
?>
             <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    <input type="hidden" name='view' value='bahantugas2'>
                    <input type="hidden" name='act' value='listbahantugas2siswa'>
                    <select name='tahun' style='padding:4px'>
                        <?php 
                            echo "<option value=''>- Pilih Tahun Akademik -</option>";
                            $tahun = mysql_query("SELECT * FROM rb_tahun_akademik");
     ...
     echo "<div class='col-xs-12'>  
              <div class='box'>
                <div class='box-header'>
                  ...
                  <a class='btn btn-danger btn-sm pull-right' href='index.php?view=bahantugas2&act=listbahantugas2&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]'>Kembali</a>
                </div>
