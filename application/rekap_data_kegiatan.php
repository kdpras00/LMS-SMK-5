    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Rekap Data Kegiatan Guru</h3>
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['tahun'])) {
                            ...
                            $tampil = mysql_query("SELECT a.kodejdwl, a.nip, a.kode_pelajaran, a.kode_kelas, 
                                                    ...
                                                    WHERE a.id_tahun_akademik='$_GET[tahun]' 
            ...
            <?php
            if (!isset($_GET['tahun'])) {
                echo "<center style='padding:60px; color:red'>Silahkan Memilih Tahun Akademik Terlebih Dahulu...</center>";
            }
            ?>
        </div>
    </div>
