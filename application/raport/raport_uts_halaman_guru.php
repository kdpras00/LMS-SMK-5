            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php if ($get_tahun != ''){ echo "Input Nilai Raport UTS"; }else{ echo "Input Nilai Raport UTS Anda ".date('Y'); } ?></h3>
                        ...
                        echo "<tr><td>$no</td>
                                  ...
                                  if ($get_tahun != ''){
                                    echo "<td style='width:70px !important'><center>
                                              <a class='btn btn-success btn-xs' title='Lihat Siswa' href='index.php?view=raportuts&act=listsiswa&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&tahun=$get_tahun'><span class='glyphicon glyphicon-th-list'></span> Input Nilai</a>
                                            </center></td>";
                                  }
