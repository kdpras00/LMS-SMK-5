            ...
            <div class="col-xs-12">  
              ...
              setTimeout(function() {
                Swal.fire({
                  ...
                  window.location = 'index.php?view=ptk';
                });
              }, 100);
            </script>";
                      }
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Nama PTK</th> <td><input type='text' class='form-control' name='a' required value='".(isset($s['jenis_ptk']) ? $s['jenis_ptk'] : '')."'> </td></tr>
    ...
    echo "<div class='col-md-12'>
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='120px' scope='row'>Nama PTK</th> <td><input type='text' class='form-control' name='a' required> </td></tr>
