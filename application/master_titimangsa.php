            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Titimangsa Rapot</h3>
              ...
              setTimeout(function() {
                Swal.fire({
                  ...
                  window.location = 'index.php?view=kelompokmapel';
                });
              }, 100);
            </script>";
                      }
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Jenis</th> <td><input type='text' class='form-control' name='a' required value='$s[jenis_kelompok_mata_pelajaran]'> </td></tr>
                    <tr><th width='120px' scope='row'>Nama Kelompok</th> <td><input type='text' class='form-control' name='b' required value='$s[nama_kelompok_mata_pelajaran]'> </td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
