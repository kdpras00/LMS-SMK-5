...
<html>
  <head>
    ...
    <style type="text/css"> 
      ...
      .content-wrapper { min-height: calc(100vh - 105px) !important; }
    </style>
        ...
        <?php 
          ...
          if ($_GET['view']=='home' OR $_GET['view']==''){
              if($_SESSION['level']=='siswa'){
                  ...
                  include "application/home_kepsek.php";
              }else{
                  echo "<div class='row'>";
          ...
          elseif ($_GET['view']=='raport'){
            ...
            echo "<div class='row'>";
                    include "application/raport/raport_kehadiran.php";
            echo "</div>";
			}elseif ($_GET['view']=='prakerin'){
            
            echo "<div class='row'>";
                    include "application/raport/raport_prakerin.php";
            echo "</div>";
