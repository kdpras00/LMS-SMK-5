<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
             <li><a href="index.php?view=absensiswa&act=detailabsensiswa"><i class="fa fa-th-large"></i> <span>Data Absensi</span></a></li>
            <li><a href="index.php?view=bahantugas&act=listbahantugassiswa"><i class="fa fa-file"></i><span>Materi dan Tugas</span></a></li>
            <!--
            ...
            <li><a href="index.php?view=journalkbm"><i class="fa fa-tags"></i><span>Agenda KBM</span></a></li>
